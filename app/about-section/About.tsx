  ...
  return (
    ...
    >
      ...
      >
        ...
        languages like C#, Python, JavaFX, TypeScript, and I also
        know my way around frameworks like .NET MAUI, Next.js, and backend
        technologies like Express.js, nodejs, and PHP.
      </motion.p>
      <motion.p
        className="p"
        initial={{ opacity: 0, y: -30, scale: 0.5 }}
